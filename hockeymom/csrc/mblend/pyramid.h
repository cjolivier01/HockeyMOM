...
class Pyramid {
 ...
 private:
  ...
  void CopyInterleavedThread_8bit(
      uint8_t* src_p,
      int step,
      int pitch,
      int sy,
      int ey);
  void CopyInterleavedThread_16bit(
      uint16_t* src_p,
      int step,
      int pitch,
      int sy,
      int ey);
  void CopyPlanarThread_8bit(
      uint8_t* src_p,
      int pitch,
      bool gamma,
      int sy,
      int ey);
  void CopyPlanarThread_16bit(
      uint16_t* src_p,
      int pitch,
      bool gamma,
      int sy,
      int ey);
  void CopyPlanarThread_32bit(
      __m128* src_p,
      int pitch,
      bool gamma,
      int sy,
      int ey);
  void Subsample_Squeeze(
      __m128* in,
      __m128* Out,
      int m128_pitch_in,
      int m128_pitch_out,
...
#define _OP_ \
 ...
 public:
  ...
  void Shrink();
  void Laplace() {
    LaplaceCollapse((int)levels.size(), false);
  };
  void Collapse() {
    LaplaceCollapse((int)levels.size(), true);
  };
  void Collapse(int n_levels) {
    LaplaceCollapse(n_levels, true);
  };
  float Average();
  ...
  int GetPitch(int level = 0) {
    return levels[level].pitch;
  };
  float* GetData(int level = 0) {
  ...
  int GetX(int level = 0) {
    return levels[level].x;
  };
  int GetY(int level = 0) {
    return levels[level].y;
  };
  static void LaplaceLine2(
      __m128* hi,
      __m128* temp1,
      __m128* temp2,
      int m128_pitch);
  static void LaplaceLine3(
      __m128* hi,
      __m128* temp1,
      __m128* temp2,
      __m128* temp3,
      int m128_pitch);
  static void LaplaceExpand(
      __m128* hi,
      __m128* lo,
      int m128_pitch_hi,
      int m128_pitch_lo);
  static void LaplaceExpandShifted(
      __m128* hi,
      __m128* lo,
      int m128_pitch_hi,
      int m128_pitch_lo);
        ...
        case 0:
          threadpool->Schedule([=] {
            OutInterleaved(
                ...
                PLL(N),
                pitch,
                levels[level].bands[b],
                levels[level].bands[b + 1],
                level,
                chroma,
                step,
                offset);
