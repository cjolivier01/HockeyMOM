...
def should_import_webapp_without_db_init():
    ...
    expected = {
        '/', '/teams', '/teams/new', '/teams/<int:team_id>', '/teams/<int:team_id>/edit',
        '/teams/<int:team_id>/players/new', '/teams/<int:team_id>/players/<int:player_id>/edit',
        '/teams/<int:team_id>/players/<int:player_id>/delete', '/schedule', '/schedule/new',
        '/hky/games/<int:game_id>', '/game_types', '/media/team_logo/<int:team_id>',
    }
