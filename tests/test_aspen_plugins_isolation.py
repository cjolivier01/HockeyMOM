...
def _case_action_factory(monkeypatch, tmp_path: Path) -> None:
...
def _case_action_pose(monkeypatch, tmp_path: Path) -> None:
...
def _case_boundaries(monkeypatch, tmp_path: Path) -> None:
...
def _case_camera_controller(monkeypatch, tmp_path: Path) -> None:
...
def _case_camera_train(monkeypatch, tmp_path: Path) -> None:
...
def _case_dataloader(monkeypatch, tmp_path: Path) -> None:
...
def _case_debug_rgb_stats(monkeypatch, tmp_path: Path) -> None:
...
def _case_detector_factory(monkeypatch, tmp_path: Path) -> None:
...
def _case_detector_inference(monkeypatch, tmp_path: Path) -> None:
...
def _case_ice_boundaries(monkeypatch, tmp_path: Path) -> None:
...
def _case_ice_config(monkeypatch, tmp_path: Path) -> None:
...
def _case_image_prep(monkeypatch, tmp_path: Path) -> None:
...
def _case_jersey_koshkina(monkeypatch, tmp_path: Path) -> None:
...
def _case_jersey_pose(monkeypatch, tmp_path: Path) -> None:
...
def _case_join(monkeypatch, tmp_path: Path) -> None:
...
def _case_load_detections(monkeypatch, tmp_path: Path) -> None:
...
def _case_load_tracking(monkeypatch, tmp_path: Path) -> None:
...
def _case_load_pose(monkeypatch, tmp_path: Path) -> None:
...
def _case_load_camera(monkeypatch, tmp_path: Path) -> None:
...
def _case_mmtracking(monkeypatch, tmp_path: Path) -> None:
...
def _case_model_config(monkeypatch, tmp_path: Path) -> None:
...
def _case_model_factory(monkeypatch, tmp_path: Path) -> None:
...
def _case_overlay(monkeypatch, tmp_path: Path) -> None:
...
def _case_play_tracker(monkeypatch, tmp_path: Path) -> None:
...
def _case_pose_factory(monkeypatch, tmp_path: Path) -> None:
...
def _case_pose_plugin(monkeypatch, tmp_path: Path) -> None:
...
def _case_pose_to_det(monkeypatch, tmp_path: Path) -> None:
...
def _case_postprocess(monkeypatch, tmp_path: Path) -> None:
...
def _case_prune(monkeypatch, tmp_path: Path) -> None:
...
def _case_save_detections(monkeypatch, tmp_path: Path) -> None:
...
def _case_save_tracking(monkeypatch, tmp_path: Path) -> None:
...
def _case_save_pose(monkeypatch, tmp_path: Path) -> None:
...
def _case_save_actions(monkeypatch, tmp_path: Path) -> None:
...
def _case_save_camera(monkeypatch, tmp_path: Path) -> None:
...
def _case_stitching(monkeypatch, tmp_path: Path) -> None:
...
def _case_tracker(monkeypatch, tmp_path: Path) -> None:
...
def _case_video_out(monkeypatch, tmp_path: Path) -> None:
...
def _case_apply_camera(monkeypatch, tmp_path: Path) -> None:
...
PLUGIN_CASES: dict[str, Callable[[Any, Path], None]] = {
...
def should_validate_each_aspen_plugin_in_isolation(
    plugin_class: str, monkeypatch, tmp_path: Path
) -> None:
    PLUGIN_CASES[plugin_class](monkeypatch, tmp_path)
