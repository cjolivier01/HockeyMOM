...
def client(monkeypatch, webapp_db):
    ...
    m.LeagueGame.objects.create(league_id=1, game_id=int(g1.id), division_name="10 B West", sort_order=None)
    m.LeagueGame.objects.create(league_id=1, game_id=int(g2.id), division_name="10 B West", sort_order=None)
    # Cross-division game (10 B West vs 12A): should be ignored for league views.
    m.LeagueGame.objects.create(league_id=1, game_id=int(g3.id), division_name="10 B West", sort_order=None)
