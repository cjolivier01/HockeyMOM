...
2. `PATH`
3. Bazel runfiles
4. `bazel-bin/hm-ui/hm-ui-bin`
5. `hm-ui/target/release/hm-ui` or `hm-ui/target/debug/hm-ui`

Wheel installs do not bundle the Rust sidecar yet. Set `HM_UI_BIN` or install `hm-ui` on `PATH` for wheel-based deployments.
