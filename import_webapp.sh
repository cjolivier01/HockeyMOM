...
./p scripts/parse_shift_spreadsheet.py --file-list ~/Videos/game_list_long.txt --shifts --upload-webapp --webapp-url=http://127.0.0.1:8008 --webapp-owner-email cjolivier01@gmail.com --league-name=Norcal
