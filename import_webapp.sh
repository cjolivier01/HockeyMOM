...
python3 scripts/parse_stats_inputs.py --file-list ~/Videos/game_list_long.txt --shifts --no-scripts --upload-webapp --webapp-url="${WEBAPP_URL}" ${WEB_ACCESS_KEY} --webapp-owner-email cjolivier01@gmail.com --webapp-league-name=Norcal
