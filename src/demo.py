...
def copy_audio(original_video: str, soundless_video: str, audio_video: str):
    ...
    cmd_str = f'ffmpeg -i {soundless_video} -i {output_audio_path} -map 0:v -map 1:a -c:v copy -shortest {audio_video}'
    print(cmd_str)
    os.system(cmd_str)
    # delete temp audio
