...
# Add CUDA repository
echo "deb [signed-by=/usr/share/keyrings/cuda-archive-keyring.gpg] https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2404/arm64 /" | sudo tee /etc/apt/sources.list.d/cuda-ubuntu2404-arm64.list
