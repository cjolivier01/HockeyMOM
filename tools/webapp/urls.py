...
urlpatterns = [
    ...
    path("api/leagues/<int:league_id>/page_views", v.api_league_page_views, name="api_league_page_views"),
    path("api/import/hockey/ensure_league", v.api_import_ensure_league, name="api_import_ensure_league"),
    ...
    path("api/import/hockey/shift_package", v.api_import_shift_package, name="api_import_shift_package"),
    ...
    path("teams/<int:team_id>/players/<int:player_id>/delete", v.player_delete, name="player_delete"),
    ...
    path("hky/games/<int:game_id>/import_shift_stats", v.hky_game_import_shift_stats, name="hky_game_import_shift_stats"),
    ...
    path("leagues/<int:league_id>/members/remove", v.league_members_remove, name="league_members_remove"),
    path("leagues/recalc_div_ratings", v.leagues_recalc_div_ratings, name="leagues_recalc_div_ratings"),
    # Public leagues
    ...
    path("public/leagues/<int:league_id>/schedule", v.public_league_schedule, name="public_league_schedule"),
    path(
