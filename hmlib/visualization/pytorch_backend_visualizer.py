...
class PytorchBackendVisualizer(Visualizer):
    ...
    Args:
        ...
        image (torch.Tensor, optional): the origin image to draw. The format
    ...
    def __init__(self,
        ...
        assert backend in ('pytorch', 'matplotlib'), f'the argument ' \
    ...
    def set_image(self, image: torch.Tensor) -> None:
        ...
        Args:
            image (torch.Tensor): The image to draw.
    ...
    def get_image(self) -> torch.Tensor:
        ...
        Returns:
            torch.Tensor: the drawn image which channel is RGB.
        """
    ...
    def draw_circles(self,
                     center: Union[torch.Tensor, torch.Tensor],
                     radius: Union[torch.Tensor, torch.Tensor],
        ...
        Args:
            center (Union[torch.Tensor, torch.Tensor]): The x coordinate of
                each line' start and end points.
            radius (Union[torch.Tensor, torch.Tensor]): The y coordinate of
                each line' start and end points.
    ...
    def draw_texts(
        ...
        positions: Union[torch.Tensor, torch.Tensor],
        ...
        **kwargs,
        ...
        Args:
            ...
            positions (Union[torch.Tensor, torch.Tensor]): The position to draw
    ...
    def draw_bboxes(self,
                    bboxes: Union[torch.Tensor, torch.Tensor],
        ...
        Args:
            bboxes (Union[torch.Tensor, torch.Tensor]): The bboxes to draw with
    ...
    @master_only
    def draw_lines(self,
                   x_datas: Union[torch.Tensor, torch.Tensor],
                   y_datas: Union[torch.Tensor, torch.Tensor],
                   colors: Union[str, tuple, List[str], List[tuple]] = 'g',
                   line_widths: Union[Union[int, float],
                                      List[Union[int, float]]] = 2,
                   **kwargs) -> 'Visualizer':
        ...
        Args:
            x_datas (Union[torch.Tensor, torch.Tensor]): The x coordinate of
                each line' start and end points.
            y_datas (Union[torch.Tensor, torch.Tensor]): The y coordinate of
                each line' start and end points.
    ...
    def draw_polygons(self,
                      polygons: Union[Union[torch.Tensor, torch.Tensor],
        ...
        Args:
            polygons (Union[Union[torch.Tensor, torch.Tensor],\
                List[Union[torch.Tensor, torch.Tensor]]]): The polygons to draw
    ...
    def show(self,
        ...
        Args:
            drawn_img (torch.Tensor, optional): The image to show. If drawn_img
