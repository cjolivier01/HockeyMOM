...
train_cfg = dict(type="EpochBasedTrainLoop", max_epochs=max_epochs, val_begin=70, val_interval=1)
...
default_hooks = dict(
    checkpoint=dict(_delete_=True, type="CheckpointHook", interval=1, max_keep_ckpts=10),
